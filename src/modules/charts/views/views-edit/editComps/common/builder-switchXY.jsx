...
const langPath = "chart.editView.switchXY.";

class SwitchXY extends React.Component {
    static propTypes = {
    ...
    componentWillReceiveProps(nextProps) {
        const { switchXY } = nextProps,
            checked = _.isBoolean(switchXY) ? switchXY : false;
    ...
    handleSwitch = () => {
        ...
        this.setState({ checked: !checked }, () => {
            onChangeProperty(identify, { switchXY: this.state.checked });
        });
    };
    render() {
