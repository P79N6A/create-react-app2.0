...
class DeploymentDialog extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            name: "",
    ...
    render() {
        ...
        const { name, nameFlag, deploymentType } = this.state;
        return (
            <div>
                <Dialog
                ...
                >
                    <DialogTitle id="alert-dialog-slide-title">Deployment</DialogTitle>
                    <DialogContent style={{ height: "100%" }}>
                        ...
                        >
                            <FormControl className={classes.formControl}>
                                <InputLabel>Deployment Name</InputLabel>
                                <Input
                                    type="text"
                                    error={nameFlag}
                                    value={name}
                            ...
                            <FormControl className={classes.formControl}>
                                <InputLabel htmlFor="select-multiple">Images Type</InputLabel>
                                <Select
                                    value={deploymentType}
                                    name="imageTpe"
                                    onChange={this.handleChange("deploymentType")}
                                    MenuProps={MenuProps}
                                    style={{ width: "95%" }}
                                >
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(withStyles(styles)(DeploymentDialog));
