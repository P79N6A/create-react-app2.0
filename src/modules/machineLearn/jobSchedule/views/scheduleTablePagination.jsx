...
class ScheduleTablePagination extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
...
ScheduleTablePagination.propTypes = {
    rowsPerPageOptions: PropTypes.array
};

ScheduleTablePagination.defaultProps = {
...
export default ScheduleTablePagination;
