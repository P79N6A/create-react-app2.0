...
class CommonSelect extends React.Component {
    ...
    componentWillMount() {
        ...
        for (let i = 0; i < selectItems.length; i++) {
            if (selectItems[i].defaultSelect) {
                currentSelect.push(selectItems[i].title);
            }
        }
    ...
    render() {
        ...
        const active = activeColor ? styles.dark : "";
        const inactive = activeColor ? "" : styles.dark;
        return (
            <FormControl
                style={{
                    width: "100%",
            ...
            >
                ...
                >
                    <MenuItem key="all-clear" value="all-clear">
                        <ListItemText style={{ textAlign: "center" }} onClick={this.handleAllClear.bind(this)}>
                    ...
                    {this.props.selectItems &&
                        this.props.selectItems.map(item => (
                            <MenuItem key={item.title} value={item.title}>
                                <Checkbox
                                    checked={
                                        this.state.currentSelect && this.state.currentSelect.indexOf(item.title) > -1
                                    }
                                />
