...
import { addLocationRequest } from "../funcs/actions";
...
class AddLocationComp extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        // go to next step
        if (!_.isEqual(this.props.location, nextProps.location) && nextProps.location) {
            ...
            let center = coordinates || nextProps.center;
            this.setState({
            ...
            this.props.handleLocationChangedFunc(
                this.props.schemaKey,
                nextProps.location["location.iotTopologyId"],
                locationName
            );
        }
...
const mapDispatchToProps = dispatch => {
    return {
        addLocation: (identify, locationName, coordinates) => {
            dispatch(addLocationRequest(identify, locationName, coordinates));
        }
    };
};
