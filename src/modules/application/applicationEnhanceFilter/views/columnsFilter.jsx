                ...
                >
                    <MenuItem key="all-clear" value="all-clear" onClick={this.handleAllClearClick.bind(this)}>
                        <ListItemText style={{ textAlign: "center" }}>
                            <span data-key="all" className={classnames({ [classes.active]: activeColor })}>
                                Select All
                            </span>
                            <span>&nbsp;-&nbsp;</span>
                            <span data-key="clear" className={classnames({ [classes.active]: !activeColor })}>
                                Clear
                            </span>
                        </ListItemText>
                    </MenuItem>
                        ...
                        columnConfig.map(column => (
                            <MenuItem key={column.columnName} value={column.columnName}>
                                ...
                                <ListItemText
                                    ...
                                    onClick={this.handleChange.bind(this, column.columnName)}
                                />
                            </MenuItem>
                        ))}
                </Menu>
