...
//     try {
//         const result = yield call(getRuleDetail, obj.sitename, obj.configname);
...
//     try {
//         const result = yield call(updateRule, obj.sitename, obj.configname, obj.configvaldesc, obj.configval, obj.user);
//         if (result && result.status) {
//             if (result.status.code === "00000000") {
//                 let resultList = yield call(getRuleData, obj.pageLimit, obj.pageNo, obj.sitename);
...
//                     yield put(ruleGridActions.getRuleDataSuccess(pagination, arrayData, obj.identify));
//                 }
...
//         if (result && result.status) {
//             if (result.status.code === "00000000") {
//                 let resultList = yield call(getRuleData, obj.pageLimit, "1", obj.sitename);
//                 if (resultList.status.code === "00000000") {
//                     let pagination = resultList.pagination;
//                     let arrayData = resultList.configs;
