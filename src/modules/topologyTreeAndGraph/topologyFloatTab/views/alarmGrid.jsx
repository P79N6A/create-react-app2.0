...
const mapStateToProps = (state, ownProps) => {
    ...
    return {
        resourcePath: filterProps(state, identify, topoGraphFloatTabReducer, "resourcePath"),
        iotId: filterProps(state, identify, topoGraphFloatTabReducer, "deviceId"),
        alarms: filterProps(state, identify, topoGraphFloatTabReducer, "alarms"),
        getAlarmSuccess: filterProps(state, identify, topoGraphFloatTabReducer, "getAlarmSuccess"),
        alarmPagination: filterProps(state, identify, topoGraphFloatTabReducer, "alarmPagination"),
        showFloatTab: filterProps(state, identify, topoGraphReducerName, "showFloatTab")
    };
};
