...
const mapStateToProps = (state, ownProps) => {
    ...
    return {
        ...
        events: filterProps(state, identify, topoGraphFloatTabReducer, "events"),
        getEventSuccess: filterProps(state, identify, topoGraphFloatTabReducer, "getEventSuccess"),
        eventPagination: filterProps(state, identify, topoGraphFloatTabReducer, "eventPagination"),
