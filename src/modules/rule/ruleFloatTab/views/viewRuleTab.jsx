...
import RuleInfoView from "./ruleInfoView";
    ...
    render() { 
        return (
            <div style={{ height: "calc(100% - 120px)" }}>
                ...
                {this.state.currentTab === 0 ?<RuleInfoView index={0} {...this.props} /> : null}
                {this.state.currentTab === 1 ? <RuleConditionView index={1} {...this.props} /> : null}
