...
import SystemRuleInfoView from "./systemRuleInfoView";
import RuleActionView from "./ruleActionView";
import SystemRuleConditionView from "./systemRuleConditionView";
    ...
    render() { 
        return (
            <div style={{ height: "calc(100% - 120px)" }}>
                ...
                {this.state.currentTab === 0 ?<SystemRuleInfoView index={0} {...this.props} /> : null}
                {this.state.currentTab === 1 ? <SystemRuleConditionView index={1} {...this.props} /> : null}
                {this.state.currentTab === 2 ? <RuleActionView index={2} {...this.props} /> : null}
            </div>
        );
    }
}
