...
export const getConfigDetail = (sitename, modulename, submodulename, configname, identify) => ({
...
export const updateRule = (sitename, modulename, submodulename, configname, configvaldesc, configval, user, pageLimit, pageNo, identify) => ({
...
export const addRule = (sitename, modulename, submodulename, configName, configvaldesc, configValue, userid, pageLimit, identify) => ({
...
export const addRuleFailure = (identify) => ({
    type: RULEFLOATTAB_ADDRULE_FAILURE,
    identify,
    refreshRuleFloatSuccess: true
});
...
export const getTopologyModelInfoFail = (identify) => ({
    type: RULEFLOATTAB_GET_DEVICEMODEL_INFO_FAIL,
    identify
});
