...
export const columnsChanged = (identify, currentCheckColumns) => ({
    type: RULE_COLUMNS_CHANGED,
    identify,
    currentCheckColumns
});

export const filtersValueChanged = (identify, filterConfig) => ({
    type: RULE_FILTERVALUE_CHANGES,
    identify,
    filterConfig
});

export const refreshRule = (identify, refreshRule) => ({
    type: RULEFILTER_REFRESH_RULE,
    identify,
