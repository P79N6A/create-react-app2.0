...
function CreatedPredicate(searchWord, propsFilterConfigType, propsFilterArr, filterType) {
    let filter = {
    ...
    if (!isThisFilterExist || searchWord.length) {
...
function checkPredicate(filterArr, predicate) {
    ...
    for (let j = 0; j < filterArr.length; j++) {
        ...
        let predicateArr = predicateObj.predicates;
        ...
        predicateObj.predicates = predicateArr;
    }
    if (filterArr.length) {
