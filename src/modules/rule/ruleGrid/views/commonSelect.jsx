...
class CommonSelect extends React.Component {
    ...
    render() {
        ...
        const active = activeColor ? classes.highlight : "";
        const inactive = activeColor ? "" : classes.highlight;
        // const { classes } = this.props;
        return (
            <FormControl
                style={{
                        ...
                        >
                            {selected.map(value => (
                                <Chip
                                    ...
                                    deleteIcon={<Icon>{I18n.t("rule.common.clear")}</Icon>}
