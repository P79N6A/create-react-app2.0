...
class SopListTablePagination extends Component {
    constructor(props) {
        super(props);
...
SopListTablePagination.propTypes = {
    // rowsPerPageOptions: PropTypes.array
};
SopListTablePagination.defaultProps = {
...
export default SopListTablePagination;
