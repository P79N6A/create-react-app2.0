...
import { REDUCER_NAME, initialState, CONSITIONS_SESSION_KEY } from "./funcs/constants";
...
export { actions, reducer, view, sagas, REDUCER_NAME as reducerName, Dialog, initialState, CONSITIONS_SESSION_KEY };
