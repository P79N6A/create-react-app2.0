...
class AddDeviceComp extends React.Component {
    ...
    addParentDeviceIdFunc(parentDeviceId) {
        this.setState(
            Object.assign(this.state, {
    ...
    render() {
        ...
        const { classes, steps, selectAppId, selectAppRespath } = this.props;
        return (
            <CardContent className="topo-add-device">
                <div className="topo-stepper">
                    ...
                    <AddDeviceStepperCont
                        ...
                        addParentDeviceIdFunc={this.addParentDeviceIdFunc.bind(this)}
