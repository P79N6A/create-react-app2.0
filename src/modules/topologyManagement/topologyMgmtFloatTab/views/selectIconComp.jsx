...
class PanelSelectIcon extends Component {
    ...
    chooseIcon = e => {
        ...
        this.props.handleDefaultAdditionalValueChange &&
            this.props.handleDefaultAdditionalValueChange("additionalProperty", "icon", e, true);
    };
            ...
            <div id="panel_icons_wrap" className="panel_icons_wrap">
                ...
                <div className="panel_color_wrapper">
                    ...
                    {currentUri ? (
                        ...
                        <Button onClick={this.handleIcons} variant="contained" color="primary" className="mark_icon" />
                    )}
                </div>
            </div>
        );
