...
import FilterSelect from "../../alarmSearch/views/filterSelect";
import { TextField } from "modules/common";
import { RangePicker } from "modules/common";
import { filtersData, filterForOperator, severityAndState, filterForValueType } from "../../alarmSearch/funcs/filter";
...
class AlarmFilter extends Component {
    ...
    state = {
        ...
        dataList: this.props.filterDataList ? this.props.filterDataList : initDataList
    };

    componentWillReceiveProps(nextProps) {
        const { filterDataList } = nextProps;
        this.setState({
                                    ...
                                    {item.filter === "Sent Datetime" ? (
                                        <div className="filter-time">
                                            <RangePicker
                                                ...
                                                id={"alarmDate" + index}
                                                onOk={this.handleSumbitDate.bind(this)}
                                            />
                                        </div>
                                    ) : (
                                        ""
