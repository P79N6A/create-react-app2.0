...
import { REDUCER_NAME as reducerName } from "modules/alarm/alarmList/funcs/constants";
import { saveStreamingData, closeWsLock } from "modules/alarm/alarmList/funcs/actions";
...
const mapDispatchToProps = (dispatch, props) => {
    return {
        ...
        callReminder: val => {
            dispatch(msg.error(val, "Alarm - Refresh"));
        },
        closeWsLock: val => {
