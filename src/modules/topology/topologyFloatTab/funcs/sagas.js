...
import { TOPOFLOATTAB_GETDETAIL, TOPOFLOATTAB_GETALARM, TOPOFLOATTAB_GETEVENT } from "./actionTypes";
...
function* getTopologyDetailSaga() {
    yield takeEvery(TOPOFLOATTAB_GETDETAIL, getTopoDetail);
}

function* getTopologyAlarmSaga() {
    yield takeEvery(TOPOFLOATTAB_GETALARM, getTopoAlarm);
}

function* getTopologyEventSaga() {
    yield takeEvery(TOPOFLOATTAB_GETEVENT, getTopoEvent);
}
