        ...
        return (
            <div className="topo-tab">
                ...
                <CardContent className="detail-cont">
                    {/* {this.state.currentTab === 0 ? <DetailExpandCard index={0} {...this.props} /> : null} */}
                    ...
                    {/* {this.state.currentTab === 3 ? <MapView index={3} {...this.props} /> : null} */}
                    {/* {this.state.currentTab === 3 ? <ReadingChart index={3} {...this.props} /> : null} */}
                </CardContent>
            </div>
        );
    }
...
const mapStateToProps = (state, ownProps) => {
    ...
    return {
        currentTab:
            state[topoFloatTabReducer] &&
            state[topoFloatTabReducer][identify] &&
            state[topoFloatTabReducer][identify].currentTab
    };
};
