...
import WidgetsBoard from "./views/container";
import * as actions from "./funcs/actions";
import { REDUCER_NAME as reducerName, INITIAL_STATE as initialState } from "./funcs/constants";
import reducers from "./funcs/reducers";
import sagas from "./funcs/sagas";

injectAsyncReducer(store, reducerName, reducers);
