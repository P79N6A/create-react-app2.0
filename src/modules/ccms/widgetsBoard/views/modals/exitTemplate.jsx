...
class ExitReminder extends React.Component {
    static defaultProps = {};
    state = {
        name: I18n.t("ccms.exitTemplate.name"),
        group: I18n.t("ccms.exitTemplate.group"),
        open: I18n.t("ccms.exitTemplate.open"),
        title: I18n.t("ccms.exitTemplate.title"),
        subTitle: I18n.t("ccms.exitTemplate.subTitle"),
        pageKey: I18n.t("ccms.exitTemplate.pageKey"),
        pageName: I18n.t("ccms.exitTemplate.pageName"),
        cancelText: I18n.t("ccms.exitTemplate.cancelText"),
        submitText: I18n.t("ccms.exitTemplate.submitText"),
        content: I18n.t("ccms.exitTemplate.content")
    };
